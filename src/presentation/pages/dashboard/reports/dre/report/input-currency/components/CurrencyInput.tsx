import React, { FC, useState, useEffect, useRef, forwardRef, useMemo, useImperativeHandle } from 'react'
...
export const CurrencyInput: any = forwardRef<HTMLInputElement, CurrencyInputProps>(
  (
    {
      allowDecimals = true,
