...
export const DepositMovements = memo(() => {
  ...
  return !canListDepositsMov || canListDepositsMov === "loading" ? (
    ...
    <section className="uk-padding">
      <h3 className="uk-margin-remove">Movimentações Depositos Estoque</h3>
      ...
      <div className="uk-margin-bottom uk-margin-small-top">
        ...
        <Row className="uk-margin-small-top">
            ...
            <InputBox className="uk-flex uk-flex-column uk-margin-small-right">
              <AutoComplete
                ...
                onSelect={(val, opt) => {
                  ...
                  setSearchParams((prv) => ({ ...prv, responsible: opt?.id }));
                }}
          ...
          {canCreateDeposit && (
            ...
            >
              <CustomButton type="primary" onClick={() => setOpenCreate(true)}>
                Nova Movimentação
              </CustomButton>
            </Col>
          )}
      ...
      >
        ...
        >
          ...
          >
            ...
            <Form.Item label="Soliciante" required style={{ width: "100%" }}>
              <AutoComplete
                options={colaborators?.map((collab) => ({
                  ...collab,
                  value: collab?.name,
          ...
          >
            ...
            >
              <Form.Item label="Produto" required style={{ width: "100%" }}>
                <AutoComplete
                  ...
                  onChange={(val) => {
                    ...
                    setAddProductData((prev) => ({ ...prev, partial: val }));
                  }}
                  onSelect={(_, opt) => {
                    // selected option
              ...
              <Form.Item label="Quantidade" required style={{ width: "40%" }}>
                <Input
                  ...
                  onClick={() => {
                    setCreateMovementData((prev) => ({
                      ...
                      items: prev.items.filter(
                        (item) =>
                          item.productVariationId !== elem.productVariationId
                      ),
                    }));
                  }}
                >
