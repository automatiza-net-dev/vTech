import { HeadComponent, Icon } from "infinity-forge";
    ...
    <Styles>
      ...
      <header>
        <div className="container">
          <img src="/images/logo/lo-logo.png" />
        </div>
      </header>
        ...
        <div>
          <div className="intern-container">
            <h2 className="font-20-bold">
              Olá, Carlos, temos um agendamento para você!
            </h2>
            ...
            <div className="list">
              <div className="item">
                ...
                <div>
                  ...
                  <p className="font-14-regular">Singular nutrição</p>
                </div>
              </div>
              ...
              <div className="item">
                ...
                <div>
                  ...
                  <p className="font-14-regular">
                    ERICA FERNANDA PEREIRA GIMENEZ - CRN-PR 3522
                  </p>
                </div>
              </div>
              ...
              <div className="item">
                ...
                <div>
                  ...
                  <p className="font-14-regular">
                    Quinta-feira, 19 de dezembro de 2022, você tem um
                    agendamento às 17hs
                  </p>
                </div>
              </div>
            ...
            <div className="buttons">
              <button className="cancel font-16">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button className="confirm font-16">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <div className="intern-container">
            ...
            <div className="list">
              ...
              <div className="item">
                <div className="icon">
                  <Icon name="IconMap" color="#fff" />
                </div>

                <div>
                  <h3 className="font-16-bold">Local de atendimento</h3>

                  <p className="font-14-regular">-</p>
                </div>
              </div>
              ...
              <div className="item">
                ...
                <div>
                  <h3 className="font-16-bold">Endereço</h3>

                  <p className="font-14-regular">
                    Av Ayrton Senna, 200, Sala 810 - ed Palhano Business, Gleba
            ...
            <div className="buttons">
              <button className="search-clinic font-16-bold">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button className="add-calendar font-16">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="container">
        ...
        <div>
          <div className="intern-container">
            <h2 className="font-20-bold">Você cancelou este agendamento!</h2>
            ...
            <p className="messa-confirm font-16">
              Ao confirmar um agendamento cancelado será verificado se o horário
